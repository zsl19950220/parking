    ...
    str += ` 
        <li class="per-item error">
            ...
            <div class="per-item-bottom">
                <div class="span-left">绿地世纪城</div>
                <div class="span-right">入口门坏了</div>
            </div>
        </li>
...
for (let k = 0; k < n; k++) {
    ...
    <li class="inner-list-li">
       ...
       <div class="li-l-r">
        ...
        <soan class="right">￥3432345.00</soan>
        </div>
        </li>
    `
}
...
for (let j = 0; j < q; j++) {
    ...
    <div class="content-bottom-li">
                        ...
                        <div class="li-car-name">郑州市-千玺广场</div>
                        <div class="li-car-number">车牌 豫A9XS66</div>
                    </div>
